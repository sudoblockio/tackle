...
# def append_from_path(provider_dict, provider_path):
...
#
#
# def import_paths(provider_dict, provider_paths):
#     """Iterate through paths and add them to provider_dict."""
#     for i in provider_paths:
#         append_from_path(provider_dict, i)
#
#
# def init_provider_dict() -> dict:
#     """"""
#     provider_dict = {}
#     import_paths(provider_dict, native_providers)
#     # Import any providers in settings
#     if settings.extra_providers:
#         import_paths(provider_dict, settings.extra_providers)
...
#     #     with work_in(".."):
#     #         import_paths([curent_dir_provider_name])
