...
#
# @pytest.fixture
# def cloned_cookiecutter_path(user_config_data):
#     """Fixture. Create fake project directory in special user folder."""
#     cookiecutters_dir = user_config_data['tackle_dir']
#
#     cloned_template_path = os.path.join(cookiecutters_dir, 'cookiecutter-pytest-plugin')
...
#     cloned_cookiecutter_path, user_config_data, change_dir_main_fixtures
# ):
#     """
