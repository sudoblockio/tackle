...
@pytest.mark.parametrize("repo_input", [
...
@pytest.mark.slow
@pytest.mark.parametrize("fixture,kwargs,assertion", [
    ('tackle-fixture-released', {'version': None, 'latest': None},
     lambda x: x.startswith('v')),
    ('tackle-fixture-released', {'version': None, 'latest': True},
     lambda x: x == 'main'),
    ('tackle-fixture-released', {'version': 'v0.1.2', 'latest': None},
     lambda x: x == 'v0.1.2'),
    ('tackle-fixture-unreleased', {'version': None, 'latest': None},
     lambda x: x == 'main'),
    ('tackle-fixture-unreleased', {'version': None, 'latest': True},
     lambda x: x == 'main'),
])
...
@pytest.mark.slow
@pytest.mark.parametrize("fixture,latest,version,assertion", [
