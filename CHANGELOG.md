...
## [0.8.0](https://github.com/sudoblockio/tackle/compare/tackle-v0.7.4...tackle-v0.8.0) (2025-12-30)


### Features

* add ability to call declarative hook nested methods ([a44165b](https://github.com/sudoblockio/tackle/commit/a44165b40b2b1b09ef1d78f1bf3ca1b998a12a0c))
* add ability to call hooks from declarative hook field defaults ([8e6d503](https://github.com/sudoblockio/tackle/commit/8e6d5034a2854dcc9938de5cc849970794aa4bbe))
* add ability to print output in yaml/toml/json from CLI ([417526d](https://github.com/sudoblockio/tackle/commit/417526d2b3f50f4d0c23d6e7b701f99e26671327))
* add auth handler for web requests pprovider ([b635dc3](https://github.com/sudoblockio/tackle/commit/b635dc3416c2e40b16a3c24f4069179059d43c0d))
* add cleanup function for when we have unquoted strings in hook args which can lead to frustrating errors that are hard to debug ([47871b3](https://github.com/sudoblockio/tackle/commit/47871b37af14269b305f15d3a00d04eec1d4ac69))
...
* add datetime provider ([b8b0cfd](https://github.com/sudoblockio/tackle/commit/b8b0cfd037ea04c8c607de76f059f47df1af2503))
...
* add default kwargs mapper field so that by default, extra fields can be mapped to another attribute ([94fc9e9](https://github.com/sudoblockio/tackle/commit/94fc9e952ab511e25af5a25d3281417af852f187))
...
* add fzf to select hook ([3a295c8](https://github.com/sudoblockio/tackle/commit/3a295c851268b807f2afff6a92364f28f3c41b0b))
* add help screen for running tackle files ([b054d2b](https://github.com/sudoblockio/tackle/commit/b054d2bba85cc43574b7eac107bc4471fb2be9d9))
* add hook decorator ([3b2e7dd](https://github.com/sudoblockio/tackle/commit/3b2e7ddfc5bfc3a388628933cd3017c2e95ebb32))
* add hook_dirs field so that tests can import hooks from another directory ([c0b16b2](https://github.com/sudoblockio/tackle/commit/c0b16b267052295701e52c4874a962cbac3ba7ca))
...
* add latest flag to pull latest version ([8c3b687](https://github.com/sudoblockio/tackle/commit/8c3b6874805a4cf08af5cab169fbc9a50f617aaf))
* add override key to cli and main to override input key ([248dbb0](https://github.com/sudoblockio/tackle/commit/248dbb0f17d4070a2c191f16030a1bd57e0a1384))
...
* add toml support ([d4698df](https://github.com/sudoblockio/tackle/commit/d4698dfdfd5999c1cc94a48f314dba3457b0d5a5))
* add xdg and comply with spec to change location of takle directory and add tests for importing ([dd0cccb](https://github.com/sudoblockio/tackle/commit/dd0cccb078b4a84517338c17340430526e8771ec))
...
* allow hooks args and kwargs to be supplied as a param ([a62b4db](https://github.com/sudoblockio/tackle/commit/a62b4db9cf0d9ed4198a170d0f4e49be520b6bfa))
...
* implement initial hook methods ([67cf309](https://github.com/sudoblockio/tackle/commit/67cf30946a2e6f3f7b024a28c1753245e43a939f))
* implement methods on declarative hooks ([60f620f](https://github.com/sudoblockio/tackle/commit/60f620f3486b98a9eb7b319e78cdd9bec7c39426))
...
* rm PartialModelMetaclass which simplifies model creation / tmp rm jinja filters ([21b4417](https://github.com/sudoblockio/tackle/commit/21b441774e0c1fc9038d3583555dbf30e3e3c428))
* segregate hooks into public and private with ability to call them externally by supplying args/kwargs/flags via CLI ([2395f91](https://github.com/sudoblockio/tackle/commit/2395f915eb463fded962461f348cdf940a5b4417))
...
* add  in JinjaHook to avoid  error [#90](https://github.com/sudoblockio/tackle/issues/90) ([ee3b036](https://github.com/sudoblockio/tackle/commit/ee3b0366393b960f150bd019378f0a4295e5164a))
...
* add field for functions ([1a56f74](https://github.com/sudoblockio/tackle/commit/1a56f74c81136394b29d041e49c9ae9d23d735aa))
...
* add smart_union to fix mangling of list inputs ([971ca88](https://github.com/sudoblockio/tackle/commit/971ca882371f7079fc5f3f7a893bf6116b0d90f4))
...
* append to list or add new key with merge in loop [#66](https://github.com/sudoblockio/tackle/issues/66) [#107](https://github.com/sudoblockio/tackle/issues/107) ([64480bc](https://github.com/sudoblockio/tackle/commit/64480bc0b11871bf4fd3972949f7e3ada1021101))
* args type in hook decorator ([791dfff](https://github.com/sudoblockio/tackle/commit/791dffff24de8e70944661f35718fc28173c2991))
* better excpetion to duplicate values and hacky logic for no_input [#104](https://github.com/sudoblockio/tackle/issues/104) ([46237f8](https://github.com/sudoblockio/tackle/commit/46237f8b50bf58126a31df2379844459951c6a0e))
...
* carry call_directory and env through hook calls ([cfe1431](https://github.com/sudoblockio/tackle/commit/cfe1431c4031218e4d4273e9e58e2371f789fdc7))
* checkbox hook with new API ([6e0b532](https://github.com/sudoblockio/tackle/commit/6e0b532e54a08de49468979971013d177ce363f3))
* checkout the right branch with unreleased providers ([ddb790d](https://github.com/sudoblockio/tackle/commit/ddb790db18d559fff92239ad46798e027a2a23c9))
...
* declarative hooks using base object types and validations ([a3aa32d](https://github.com/sudoblockio/tackle/commit/a3aa32db5bd2da67b2e2afe06977b50768f783c7))
* double calling hook with declarative hook field default calling hook ([91f9cd1](https://github.com/sudoblockio/tackle/commit/91f9cd1cd3b374e174b2e72a173e3743c285a2bd))
* drop used hooks from globals to fix second use of hook bug which didn't reinitialize and catch errors better ([f836229](https://github.com/sudoblockio/tackle/commit/f836229e1e813e00c97e8501f62fe5ad93d9f090))
* duplicate hook  to ([4828bb5](https://github.com/sudoblockio/tackle/commit/4828bb587996355f0e557af153bdeb637817ab70))
...
* error parsing multiple args in declarative hook [#106](https://github.com/sudoblockio/tackle/issues/106) ([6181275](https://github.com/sudoblockio/tackle/commit/6181275184dd0829115becb2957cfca73647b0b4))
* error passing context to jinja hook calls ([cfdda49](https://github.com/sudoblockio/tackle/commit/cfdda495684129623129bc5b8f16cb9d40b43dd9))
...
* extends in declarative hooks ([8b33e6c](https://github.com/sudoblockio/tackle/commit/8b33e6c1f9eff7d5b81c661eacc5af2c0681c72b))
...
* fixture that had invalid validator ([8dbf575](https://github.com/sudoblockio/tackle/commit/8dbf57573be7eac2a483cfb7056e3f7420150f2b))
* install requirements.txt install when there is a ModuleNotFound error on importing a provider's hook ([047f542](https://github.com/sudoblockio/tackle/commit/047f542d4cfcbbbe6274bfca39099f676e5a8b47))
...
* issue with non-defaulted base parameters when calling declarative hook methods ([da315d9](https://github.com/sudoblockio/tackle/commit/da315d957b7f2ec127395ec87d8ea91d49c6202b))
* issue with unquoted string cleanup function on empty dicts: ([b1e8b3f](https://github.com/sudoblockio/tackle/commit/b1e8b3faf60c018f143b019f85732b13abe639d2))
...
* nested declarative hook nested method call ([d9cbf11](https://github.com/sudoblockio/tackle/commit/d9cbf11b8d0f16dbd115d39f1a798194ca288c2d))
...
* print in the case of non list / dict outputs ([11ea041](https://github.com/sudoblockio/tackle/commit/11ea041e5e5c3c8b49e4d0ff8553e8c1dca06033))
* prompt in  hook ([4bbbd23](https://github.com/sudoblockio/tackle/commit/4bbbd23447f4825c468aa169d8dee289961f1e62))
...
* update hook to actually update the values instead of overwriting them ([6a767bc](https://github.com/sudoblockio/tackle/commit/6a767bc46211727ec55e476101bc862beeef8346))
...
* field hook tests ([a2eff54](https://github.com/sudoblockio/tackle/commit/a2eff54dc79f666454021086db5fda80f03f8a8d))
...
* tackle-box to tackle ([3977a85](https://github.com/sudoblockio/tackle/commit/3977a85646fecdcfc4c1d1d15abf3698ea3d9bf3))


### Provider Changes

* add  hook ([6a6abd9](https://github.com/sudoblockio/tackle/commit/6a6abd96a35a917595c8f220e2fb8016855875ae))
* add  hook ([ad5b86b](https://github.com/sudoblockio/tackle/commit/ad5b86b3374edf72ccfb71f611bec6372d458167))
* add  hook in tackle provider ([40cf028](https://github.com/sudoblockio/tackle/commit/40cf028fbf8da8affe8b55cf1e56f7c460581271))
* add ability to run tackle hook with args that map to default hooks args ([d1c72d2](https://github.com/sudoblockio/tackle/commit/d1c72d23674734267ee7dfdeaea76afde8092549))
* add chdir hook ([1636ce0](https://github.com/sudoblockio/tackle/commit/1636ce0216d6a722ee175f72393f1b53ab62a32c))
* add default to listdir path ([30357ce](https://github.com/sudoblockio/tackle/commit/30357ce4aa222aa5112407056652222022f60139))
* add glob hook ([1a4b20f](https://github.com/sudoblockio/tackle/commit/1a4b20f46c8d9f87b9888e31ccbdc60f6e5b4014))
...
* add skip_overwrite_files and skip_overwrite_files to generate hook ([95f31b0](https://github.com/sudoblockio/tackle/commit/95f31b04be8bd07821650d704306241ed8724715))
* add update section hook ([9fac6fb](https://github.com/sudoblockio/tackle/commit/9fac6fb45425b752232c78762159e487e3029bc6))
* add wip  hook for calling arbitrary CLIs ([2a15c82](https://github.com/sudoblockio/tackle/commit/2a15c826316d9268a12b51404606b1d9ebcc8141))
